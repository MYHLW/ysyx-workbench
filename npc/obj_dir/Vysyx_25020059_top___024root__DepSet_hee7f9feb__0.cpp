...
void Vysyx_25020059_top___024root___nba_sequent__TOP__2(Vysyx_25020059_top___024root* vlSelf);
void Vysyx_25020059_top___024root___nba_sequent__TOP__3(Vysyx_25020059_top___024root* vlSelf);
...
void Vysyx_25020059_top___024root___eval_nba(Vysyx_25020059_top___024root* vlSelf) {
    ...
    if ((3ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vysyx_25020059_top___024root___nba_sequent__TOP__2(vlSelf);
        vlSelfRef.__Vm_traceActivity[2U] = 1U;
    }
    if ((6ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vysyx_25020059_top___024root___nba_sequent__TOP__3(vlSelf);
    }
...
VL_INLINE_OPT void Vysyx_25020059_top___024root___nba_sequent__TOP__3(Vysyx_25020059_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vysyx_25020059_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020059_top___024root___nba_sequent__TOP__3\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vysyx_25020059_top___024root___nba_comb__TOP__0(Vysyx_25020059_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vysyx_25020059_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020059_top___024root___nba_comb__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.ysyx_25020059_top__DOT__alu_src2 = ((2U 
