...
void Vysyx_25020059_top___024root__trace_chg_0_sub_0(Vysyx_25020059_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+19,(vlSelfRef.rst));
    bufp->chgIData(oldp+20,(vlSelfRef.inst),32);
    bufp->chgIData(oldp+21,(vlSelfRef.curr_pc),32);
    bufp->chgIData(oldp+22,(vlSelfRef.next_pc),32);
    bufp->chgIData(oldp+23,(vlSelfRef.reg_f[0]),32);
    bufp->chgIData(oldp+24,(vlSelfRef.reg_f[1]),32);
    bufp->chgIData(oldp+25,(vlSelfRef.reg_f[2]),32);
    bufp->chgIData(oldp+26,(vlSelfRef.reg_f[3]),32);
    bufp->chgIData(oldp+27,(vlSelfRef.reg_f[4]),32);
    bufp->chgIData(oldp+28,(vlSelfRef.reg_f[5]),32);
    bufp->chgIData(oldp+29,(vlSelfRef.reg_f[6]),32);
    bufp->chgIData(oldp+30,(vlSelfRef.reg_f[7]),32);
    bufp->chgIData(oldp+31,(vlSelfRef.reg_f[8]),32);
    bufp->chgIData(oldp+32,(vlSelfRef.reg_f[9]),32);
    bufp->chgIData(oldp+33,(vlSelfRef.reg_f[10]),32);
    bufp->chgIData(oldp+34,(vlSelfRef.reg_f[11]),32);
    bufp->chgIData(oldp+35,(vlSelfRef.reg_f[12]),32);
    bufp->chgIData(oldp+36,(vlSelfRef.reg_f[13]),32);
    bufp->chgIData(oldp+37,(vlSelfRef.reg_f[14]),32);
    bufp->chgIData(oldp+38,(vlSelfRef.reg_f[15]),32);
    bufp->chgIData(oldp+39,(vlSelfRef.reg_f[16]),32);
    bufp->chgIData(oldp+40,(vlSelfRef.reg_f[17]),32);
    bufp->chgIData(oldp+41,(vlSelfRef.reg_f[18]),32);
    bufp->chgIData(oldp+42,(vlSelfRef.reg_f[19]),32);
    bufp->chgIData(oldp+43,(vlSelfRef.reg_f[20]),32);
    bufp->chgIData(oldp+44,(vlSelfRef.reg_f[21]),32);
    bufp->chgIData(oldp+45,(vlSelfRef.reg_f[22]),32);
    bufp->chgIData(oldp+46,(vlSelfRef.reg_f[23]),32);
    bufp->chgIData(oldp+47,(vlSelfRef.reg_f[24]),32);
    bufp->chgIData(oldp+48,(vlSelfRef.reg_f[25]),32);
    bufp->chgIData(oldp+49,(vlSelfRef.reg_f[26]),32);
    bufp->chgIData(oldp+50,(vlSelfRef.reg_f[27]),32);
    bufp->chgIData(oldp+51,(vlSelfRef.reg_f[28]),32);
    bufp->chgIData(oldp+52,(vlSelfRef.reg_f[29]),32);
    ...
    bufp->chgBit(oldp+63,(((0U != (IData)(vlSelfRef.ysyx_25020059_top__DOT__reg1_raddr)) 
