...
void Vysyx_25020059_top___024root__trace_chg_0_sub_0(Vysyx_25020059_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
        ...
        bufp->chgCData(oldp+26,((0xfU & ((0U == (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_size))
                                          ...
                                          : ((1U == (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_size))
                                              ...
                                              : ((2U 
                                                  ...
                                                  ? 0xfU
                                                  : 0U))))),4);
        bufp->chgIData(oldp+27,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__write_data),32);
        bufp->chgIData(oldp+28,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__raw),32);
    }
    bufp->chgBit(oldp+29,(vlSelfRef.clk));
    bufp->chgBit(oldp+30,(vlSelfRef.rst));
    bufp->chgIData(oldp+31,(vlSelfRef.inst),32);
    bufp->chgIData(oldp+32,(vlSelfRef.curr_pc),32);
    bufp->chgIData(oldp+33,(vlSelfRef.next_pc),32);
    bufp->chgIData(oldp+34,(vlSelfRef.reg_f[0]),32);
    bufp->chgIData(oldp+35,(vlSelfRef.reg_f[1]),32);
    bufp->chgIData(oldp+36,(vlSelfRef.reg_f[2]),32);
    bufp->chgIData(oldp+37,(vlSelfRef.reg_f[3]),32);
    bufp->chgIData(oldp+38,(vlSelfRef.reg_f[4]),32);
    bufp->chgIData(oldp+39,(vlSelfRef.reg_f[5]),32);
    bufp->chgIData(oldp+40,(vlSelfRef.reg_f[6]),32);
    bufp->chgIData(oldp+41,(vlSelfRef.reg_f[7]),32);
    bufp->chgIData(oldp+42,(vlSelfRef.reg_f[8]),32);
    bufp->chgIData(oldp+43,(vlSelfRef.reg_f[9]),32);
    bufp->chgIData(oldp+44,(vlSelfRef.reg_f[10]),32);
    bufp->chgIData(oldp+45,(vlSelfRef.reg_f[11]),32);
    bufp->chgIData(oldp+46,(vlSelfRef.reg_f[12]),32);
    bufp->chgIData(oldp+47,(vlSelfRef.reg_f[13]),32);
    bufp->chgIData(oldp+48,(vlSelfRef.reg_f[14]),32);
    bufp->chgIData(oldp+49,(vlSelfRef.reg_f[15]),32);
    bufp->chgIData(oldp+50,(vlSelfRef.reg_f[16]),32);
    bufp->chgIData(oldp+51,(vlSelfRef.reg_f[17]),32);
    bufp->chgIData(oldp+52,(vlSelfRef.reg_f[18]),32);
    bufp->chgIData(oldp+53,(vlSelfRef.reg_f[19]),32);
    bufp->chgIData(oldp+54,(vlSelfRef.reg_f[20]),32);
    bufp->chgIData(oldp+55,(vlSelfRef.reg_f[21]),32);
    bufp->chgIData(oldp+56,(vlSelfRef.reg_f[22]),32);
    bufp->chgIData(oldp+57,(vlSelfRef.reg_f[23]),32);
    bufp->chgIData(oldp+58,(vlSelfRef.reg_f[24]),32);
    bufp->chgIData(oldp+59,(vlSelfRef.reg_f[25]),32);
    bufp->chgIData(oldp+60,(vlSelfRef.reg_f[26]),32);
    bufp->chgIData(oldp+61,(vlSelfRef.reg_f[27]),32);
    bufp->chgIData(oldp+62,(vlSelfRef.reg_f[28]),32);
    bufp->chgIData(oldp+63,(vlSelfRef.reg_f[29]),32);
    bufp->chgIData(oldp+64,(vlSelfRef.reg_f[30]),32);
    bufp->chgIData(oldp+65,(vlSelfRef.reg_f[31]),32);
    bufp->chgBit(oldp+66,(vlSelfRef.ysyx_25020059_top__DOT__rst_n));
    bufp->chgIData(oldp+67,(vlSelfRef.reg_f[0xaU]),32);
    bufp->chgCData(oldp+68,((0x7fU & vlSelfRef.inst)),7);
    bufp->chgCData(oldp+69,((7U & (vlSelfRef.inst >> 0xcU))),3);
    bufp->chgCData(oldp+70,((vlSelfRef.inst >> 0x19U)),7);
    ...
    bufp->chgCData(oldp+73,((0x1fU & (vlSelfRef.inst 
                                      >> 0x14U))),5);
    bufp->chgSData(oldp+74,((vlSelfRef.inst >> 0x14U)),12);
}
