...
void Vysyx_25020059_top___024root__trace_chg_0_sub_0(Vysyx_25020059_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[2U])) {
        bufp->chgBit(oldp+26,(vlSelfRef.ysyx_25020059_top__DOT__ena));
        bufp->chgCData(oldp+27,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__wmask_reg),4);
        bufp->chgIData(oldp+28,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__wdata_reg),32);
        bufp->chgIData(oldp+29,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__addr_reg),32);
        bufp->chgBit(oldp+30,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__write_pending));
    }
    ...
    bufp->chgIData(oldp+68,(vlSelfRef.reg_f[0xaU]),32);
    bufp->chgCData(oldp+69,((0x7fU & vlSelfRef.inst)),7);
    bufp->chgCData(oldp+70,((7U & (vlSelfRef.inst >> 0xcU))),3);
    bufp->chgCData(oldp+71,((vlSelfRef.inst >> 0x19U)),7);
    ...
    bufp->chgCData(oldp+74,((0x1fU & (vlSelfRef.inst 
                                      >> 0x14U))),5);
    bufp->chgSData(oldp+75,((vlSelfRef.inst >> 0x14U)),12);
}
