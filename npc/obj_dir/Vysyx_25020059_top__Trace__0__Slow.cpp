...
VL_ATTR_COLD void Vysyx_25020059_top___024root__trace_init_sub__TOP__0(Vysyx_25020059_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+35,0,"inst",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+36,0,"curr_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+37,0,"next_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("reg_f", VerilatedTracePrefixType::ARRAY_UNPACKED);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+38+i*1,0,"",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, true,(i+0), 31,0);
    }
    tracep->popPrefix();
    ...
    tracep->popPrefix();
    tracep->declBit(c+70,0,"rst_n",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+30,0,"wmask",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+31,0,"write_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+32,0,"raw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
    ...
    tracep->declBus(c+36,0,"curr_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+33,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+70,0,"rst_n",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+37,0,"next_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+36,0,"curr_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_25020059_top___024root__trace_full_0_sub_0(Vysyx_25020059_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+13,((((~ (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_wen)) 
    ...
    bufp->fullCData(oldp+30,((0xfU & ((0U == (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_size))
                                       ? ((IData)(1U) 
                                       ...
                                       : ((1U == (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_size))
                                           ...
                                           : ((2U == (IData)(vlSelfRef.ysyx_25020059_top__DOT__mem_size))
                                               ? 0xfU
                                               : 0U))))),4);
    bufp->fullIData(oldp+31,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__write_data),32);
    bufp->fullIData(oldp+32,(vlSelfRef.ysyx_25020059_top__DOT__u_mem_if_0__DOT__raw),32);
    bufp->fullBit(oldp+33,(vlSelfRef.clk));
    bufp->fullBit(oldp+34,(vlSelfRef.rst));
    bufp->fullIData(oldp+35,(vlSelfRef.inst),32);
    bufp->fullIData(oldp+36,(vlSelfRef.curr_pc),32);
    bufp->fullIData(oldp+37,(vlSelfRef.next_pc),32);
    bufp->fullIData(oldp+38,(vlSelfRef.reg_f[0]),32);
    bufp->fullIData(oldp+39,(vlSelfRef.reg_f[1]),32);
    bufp->fullIData(oldp+40,(vlSelfRef.reg_f[2]),32);
    bufp->fullIData(oldp+41,(vlSelfRef.reg_f[3]),32);
    bufp->fullIData(oldp+42,(vlSelfRef.reg_f[4]),32);
    bufp->fullIData(oldp+43,(vlSelfRef.reg_f[5]),32);
    bufp->fullIData(oldp+44,(vlSelfRef.reg_f[6]),32);
    bufp->fullIData(oldp+45,(vlSelfRef.reg_f[7]),32);
    bufp->fullIData(oldp+46,(vlSelfRef.reg_f[8]),32);
    bufp->fullIData(oldp+47,(vlSelfRef.reg_f[9]),32);
    bufp->fullIData(oldp+48,(vlSelfRef.reg_f[10]),32);
    bufp->fullIData(oldp+49,(vlSelfRef.reg_f[11]),32);
    bufp->fullIData(oldp+50,(vlSelfRef.reg_f[12]),32);
    bufp->fullIData(oldp+51,(vlSelfRef.reg_f[13]),32);
    bufp->fullIData(oldp+52,(vlSelfRef.reg_f[14]),32);
    bufp->fullIData(oldp+53,(vlSelfRef.reg_f[15]),32);
    bufp->fullIData(oldp+54,(vlSelfRef.reg_f[16]),32);
    bufp->fullIData(oldp+55,(vlSelfRef.reg_f[17]),32);
    bufp->fullIData(oldp+56,(vlSelfRef.reg_f[18]),32);
    bufp->fullIData(oldp+57,(vlSelfRef.reg_f[19]),32);
    bufp->fullIData(oldp+58,(vlSelfRef.reg_f[20]),32);
    bufp->fullIData(oldp+59,(vlSelfRef.reg_f[21]),32);
    bufp->fullIData(oldp+60,(vlSelfRef.reg_f[22]),32);
    bufp->fullIData(oldp+61,(vlSelfRef.reg_f[23]),32);
    bufp->fullIData(oldp+62,(vlSelfRef.reg_f[24]),32);
    bufp->fullIData(oldp+63,(vlSelfRef.reg_f[25]),32);
    bufp->fullIData(oldp+64,(vlSelfRef.reg_f[26]),32);
    bufp->fullIData(oldp+65,(vlSelfRef.reg_f[27]),32);
    bufp->fullIData(oldp+66,(vlSelfRef.reg_f[28]),32);
    bufp->fullIData(oldp+67,(vlSelfRef.reg_f[29]),32);
    bufp->fullIData(oldp+68,(vlSelfRef.reg_f[30]),32);
    bufp->fullIData(oldp+69,(vlSelfRef.reg_f[31]),32);
    bufp->fullBit(oldp+70,(vlSelfRef.ysyx_25020059_top__DOT__rst_n));
